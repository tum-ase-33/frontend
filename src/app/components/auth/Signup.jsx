    ...
    return (
      <div className="form-container">
        ...
        <form onSubmit={handleSubmit(this.handleFormSubmit)}>
          ...
          {/* Lastname */}
          <Field name="matrikelNr" component={renderField} type="text" placeholder="matrikelNr" />
...
const validate = props => {
  const errors = {};
  const fields = ['matrikelNr', 'email', 'password', 'repassword'];
